        ...
        $.getJSON(data, function(data) {
            $.each(data, function(key, val) {
                ...
                $(myItems).each(function(data, val){
                    ...
                    $('<span class="my-qtd el'+qtd+'" style="text-align: center; font-size: 13px !important;">Faltam <b>'+qtd+'</b> itens desse produto.</span>').insertAfter(myParent);
                
                    $('.product-shelf__id').each(function(){
                        var myFirstElement = $('.my-qtd').first();
                        myFirstElement.nextAll().remove();
                    });
