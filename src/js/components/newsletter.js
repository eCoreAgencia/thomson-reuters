class Newsletter {
    ...
    sendNews() {
        $('.main-footer .search-button__footer, .mobile-footer .search-button__footer').on('click', function(e) {
            e.preventDefault();

            let inputVal = $('.search-bar__input').val();
            ...
            if(pattern.test(inputVal)) {
                ...
                $.ajax({
                    ...
                    error : function() {
						alert('Ops! Aconteceu algum problema. Por favor, tente novamente.');
                    }
                });
            } else {
